  ...
  const handleUserChange = (e) => {
    ...
    if (name === "username") {
      if (value.length > 8) {
        setErrors((prev) => ({
          ...prev,
          username: "Username must be less that 8 characters long.",
        }));
      } else {
      ...
      if (value.length > 30) {
        setErrors((prev) => ({
          ...prev,
          address: "Address must be less than 30 characters.",
        }));
      } else {
    ...
    <Flex minH="100vh">
      ...
      >
        ...
        <VStack spacing={4} align="start">
          <Button w="full" onClick={onOpenAccounts}>
            View Accounts
          </Button>
          <Button w="full" onClick={onOpenCreateAccount}>
            Create Account
          </Button>
          ...
          <Flex wrap="wrap" gap={4}>
            ...
            >
              <Heading size="lg" mb={4} textAlign="center" color="gray.700">
                <i className="fa-solid fa-money-bill-1"></i> Welcome to the
                Admin Dashboard
              </Heading>
              <Divider />
            </Box>
          ...
          <ModalBody>
            {isRegisteringUser ? (
              <>
                ...
                <Button colorScheme="teal" onClick={handleRegisterUser}>
                  Register User
                </Button>
              </>
            ) : (
